    ...
    a(document).ready(function () {
        ...
        a.fn.postLike = function () {
            ...
            if (a(this).hasClass("actived")) {
                ...
                console.log(w)
                a.post("http://127.0.0.1:8000/api/v1/is_love/", w, function (A) {
                    console.log(A)
                    if (A == "false") {
                        alert("登录之后才可以点赞")
                        return false
                        ...
                        var count1 = (parseInt(x.text()) + 1).toString()
                        x.text(count1)
                        return false
                    } else {
                        alert("这个文章您已经点过赞了")
        ...
        a("#submit").on("click", function () {
            ...
            a.ajax({
                url: "http://127.0.0.1:8000/comment/add-comment",
                ...
                success: function (B) {
                    ...
                    if ($("#respond").attr("status") == "1") {
                        a("#new_comm_" + k).hide().append(B);
                    } else {
                        $($this).parents("#respond").prev().after(B)
